  ...
  <div class='d-flex align-center justify-center'>
    <div class='content-box'>
      ...
      <v-form v-model='valid'>
        ...
        <v-text-field v-model='password' label='Senha' :rules="passwordRules" type='password' required />
        <v-text-field v-model='passwordConfirmation' label='Confirmar senha' :rules="[password === passwordConfirmation || 'Senhas devem ser iguais']" type='password' required />
...
export default {
  data: () => ({
    ...
    emailRules: [
      ...
      (v) => /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(v) || 'E-mail deve ser válido'
    ],
    passwordRules: [
